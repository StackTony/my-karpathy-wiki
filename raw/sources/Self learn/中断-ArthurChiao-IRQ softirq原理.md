...
[« K8s 的核心是 API 而非容器（一）：从理论到 CRD 实践（2022）](https://arthurchiao.art/blog/k8s-is-about-apis-zh/) [Linux 网络栈接收数据（RX）：原理及内核实现（2022） »](https://arthurchiao.art/blog/linux-net-stack-implementation-rx-zh/)