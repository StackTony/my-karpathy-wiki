...
For more information, go to [Harness Git Experience quickstart](https://developer.harness.io/docs/platform/git-experience/configure-git-experience-for-harness-entities).
...
For more information, see **Manual branch selection** in [Harness Git Experience quickstart](https://developer.harness.io/docs/platform/git-experience/configure-git-experience-for-harness-entities).
...
- **Use the Harness Deploy stage to define and automate your deployment process.** For more information, go to [Deploy services on different platforms](https://developer.harness.io/docs/category/deploy-services-on-different-platforms).
- **Integrate your APM provider using the Verify step.** The Verify step connects with your APM provider to provide realtime APM metrics in the context of your application deployment. Using AI/ML, Harness can assist with an automated decision to roll back or fail a deployment based on your APM provider metrics. For more information, go to [Continuous Verification (CV)](https://developer.harness.io/docs/continuous-delivery/verify/verify-deployments-with-the-verify-step).
- **Use built-in steps for testing.** Using our Shell Script step, HTTP step, Plugin step, or Run step, you can run tests on your deployed applications. For more information, go to:
	- [Shell Script step](https://developer.harness.io/docs/continuous-delivery/x-platform-cd-features/cd-steps/utilities/shell-script-step).
		- [HTTP step](https://developer.harness.io/docs/continuous-delivery/x-platform-cd-features/cd-steps/utilities/http-step).
		- [Plugin step](https://developer.harness.io/docs/continuous-delivery/x-platform-cd-features/cd-steps/containerized-steps/plugin-step).
		- [Run step](https://developer.harness.io/docs/continuous-delivery/x-platform-cd-features/cd-steps/containerized-steps/run-step).
...
This propagation ensures the version that is deployed to a lower environment progress to a higher environment. Using the Harness [propagate service](https://developer.harness.io/docs/continuous-delivery/x-platform-cd-features/services/propagate-and-override-cd-services) feature, you can propagate the same service and artifact across multiple environments.
...
With Harness service and environment configuration management, you can ensure the environment variables are properly configured for each deployment stage. For more information on environments, go to [Environments overview](https://developer.harness.io/docs/continuous-delivery/x-platform-cd-features/environments/environment-overview).

Using templates, you can define service-agnostic stages that can be used to deploy to any environment. For more information on templates, go to [Create a stage template](https://developer.harness.io/docs/platform/templates/add-a-stage-template).
...
![](https://developer.harness.io/assets/images/0f681bd509d34ce35bae99ab643dc16c6b9851b216b856ffe0968d2426d9a03a-6d7ca5b9e216630b597de3a57218850f.png "Click to view full size image")
...
For more information, go to [Add a pipeline notification strategy](https://developer.harness.io/docs/continuous-delivery/x-platform-cd-features/cd-steps/notify-users-of-pipeline-events).
...
For more information, go to [Define a failure strategy on stages and steps](https://developer.harness.io/docs/continuous-delivery/x-platform-cd-features/executions/step-failure-strategy-settings).
...
For more information, go to [Provisioning overview](https://developer.harness.io/docs/continuous-delivery/cd-infrastructure/provisioning-overview).
...
For more information, go to [Looping strategies overview (matrix, repeat, and parallelism)](https://developer.harness.io/docs/platform/pipelines/looping-strategies/looping-strategies-matrix-repeat-and-parallelism).
...
For more information on projects, go to [Organizations and projects overview](https://developer.harness.io/docs/platform/get-started/key-concepts#organizations-and-projects).
...
- [Add a variable](https://developer.harness.io/docs/platform/variables-and-expressions/add-a-variable).
...
For more information, go to [Verify deployments with the Verify step](https://developer.harness.io/docs/continuous-delivery/verify/verify-deployments-with-the-verify-step).
...
- [Notify users of pipeline events](https://developer.harness.io/docs/continuous-delivery/x-platform-cd-features/cd-steps/notify-users-of-pipeline-events).
- [Define a failure strategy on stages and steps](https://developer.harness.io/docs/continuous-delivery/x-platform-cd-features/executions/step-failure-strategy-settings).
...
- [Monitor CD deployments](https://developer.harness.io/docs/continuous-delivery/monitor-deployments/monitor-cd-deployments).
...
For more information on modeling, go to [CD pipeline modeling overview](https://developer.harness.io/docs/continuous-delivery/cd-onboarding/new-user/cd-pipeline-modeling-overview).